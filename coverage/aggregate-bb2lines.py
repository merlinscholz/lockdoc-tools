...
def main():
    ...
    parser.add_argument('-f', '--filter-pattern', help="Aggregates all filenames with regex pattern in name.")
    parser.add_argument('-a', '--aggregate-dir', action="store_true", help="Aggregates to dirnames")
